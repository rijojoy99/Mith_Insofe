...
student_data$CityCode <- as.factor(student_data$CityCode)
student_data$CityTier <- as.factor(student_data$CityTier)
student_data$Year.of.Graduation.Completion <- as.factor(student_data$Year.of.Graduation.Completion)
student_data$Date.Of.Birth <- as.factor(student_data$Date.Of.Birth)
...
student_data$CityTier <- NULL
student_data$CityCode <- NULL
student_data$State <- NULL
student_data$ Discipline <- NULL
student_data$Board.in.Twelth <- NULL
